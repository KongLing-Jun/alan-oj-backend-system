package com.thinking.common.security.interceptor;
 ...
 * @description : [token拦截器组件]
 * @createTime : [2025/1/20 22:38]
 * @updateUser : [KongLingJun]
 * @updateTime : [2025/1/20 22:38]
 * @updateRemark : [v1.0]
 */
@Component
public class TokenInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        tokenService.extendTokenTime(claims);
        return true;
    }
